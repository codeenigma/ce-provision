...
# Example name.
build_example(){
  PROVISION_CMD="/bin/sh /home/ce-dev/ce-provision/scripts/provision.sh --repo dummy --branch dummy --workspace /home/ce-dev/ce-provision/ce-dev/ansible --playbook examples/$1/$1.yml"
