...
openvpn:
  ...
  # Alter cipher with care, you must alter the client_tls_cipher to match, do not set them to incompatible values
  ...
  client_tls_cipher: "" # defaults to TLS-ECDHE-ECDSA-WITH-AES-128-GCM-SHA256, see https://github.com/angristan/openvpn-install/blob/master/openvpn-install.sh#L486-L518
