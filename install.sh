...
echo "-------------------------------------------------"
echo "### ce-python"
su - "$CONTROLLER_USER" -c "cd /home/$CONTROLLER_USER/ce-provision && /home/$CONTROLLER_USER/ce-python/bin/ansible-galaxy collection list"
su - "$CONTROLLER_USER" -c "/home/$CONTROLLER_USER/ce-python/bin/ansible-galaxy role list --roles-path /home/$CONTROLLER_USER/ce-provision/galaxy/roles"
echo "### system python"
su - "$CONTROLLER_USER" -c "cd /home/$CONTROLLER_USER/ce-provision && ansible-galaxy collection list"
su - "$CONTROLLER_USER" -c "cd /home/$CONTROLLER_USER/ce-provision && ansible-galaxy role list"
